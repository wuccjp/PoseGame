...
def draw_corners(frame, detected: set):
    ...
    for label, (rx1, ry1, rx2, ry2) in corners.items():
        ...
        if active:
            draw.rectangle([rx1, ry1, rx2, ry2], fill=color_rgb + (210,))
            draw.rectangle([rx1, ry1, rx2, ry2], outline=(255, 255, 255, 200), width=4)
        else:
            draw.rectangle([rx1, ry1, rx2, ry2], fill=(30, 30, 30, 140))
            draw.rectangle([rx1, ry1, rx2, ry2], outline=(80, 80, 80, 160), width=2)
        ...
        text_color = (15, 15, 15, 255) if active else (100, 100, 100, 200)
